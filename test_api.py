...
def main():
    ...
    # Test file upload (this will require Google API key)
    print("🧪 Testing File Upload (requires GOOGLE_API_KEY)...")
    if not os.getenv('GOOGLE_API_KEY'):
        print("⚠️  GOOGLE_API_KEY not set - file upload test will fail")
